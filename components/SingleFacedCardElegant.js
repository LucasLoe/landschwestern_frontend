            ...
            direction == "left" ?
                (<div className="flex flex-col lg:flex-row w-full h-auto bg-white my-2 lg:my-8 mx-auto">
                    ...
                    <div className="w-full h-full px-8 py-4">
                        <h3 className="text-[color:var(--ls-blue)] text-center lg:text-left text-3xl font-extrabold mx-auto lg:mr-auto lg:ml-0  mb-4 mark mark-purple">{title}</h3>
                ...
                (<div className="flex flex-col-reverse lg:flex-row w-full h-auto bg-white my-2 lg:my-8 mx-auto">
                    <div className="w-full h-full px-8 py-4">
                        <h3 className="text-[color:var(--ls-blue)] text-center lg:text-right text-3xl font-extrabold mx-auto lg:ml-auto lg:mr-0 mb-4 mark mark-purple">{title}</h3>
