...
export default function WelcomePageColoredBox({ title = '...', text = '...', icon = { faHandsHolding }, bgColor = 'bg-[color:var(--ls-yellow)]' }) {
    ...
    return (
        <div className="container mx-auto lg:mx-[2vw] w-fit animate-fade-in relative overflow-visible text-center lg:text-left t-[-200px] lg:t-0">
            ...
            <div className="test block w-[320px] min-w-[300px] mx-auto">
                <ul className='mt-8'>
                    <p className='text-[color:var(--ls-white)] font-semibold tracking-wide text-xl my-8 mx-auto'><FontAwesomeIcon icon={faAngleRight} />  Das ist ein kurzer Stichpunkt zum Thema darüber</p>

                    <p className='text-[color:var(--ls-white)] font-semibold stracking-wide text-xl my-8 mx-auto'><FontAwesomeIcon icon={faAngleRight} /> Das ist ein kurzer Stichpunkt zum Thema darüber</p>
