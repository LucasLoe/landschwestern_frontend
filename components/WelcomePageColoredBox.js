...
export default function WelcomePageColoredBox({ title = '...', text = '...', icon = { faHandsHolding }, bgColor = 'bg-[color:var(--ls-yellow)]' }) {
    ...
    return (
        <div className="container mx-auto lg:mx-4 w-content animate-fade-in relative overflow-visible text-center lg:text-left t-[-200px] lg:t-0">
            <div className={`willkommen-catbox ${bgColor} my-2 mx-auto h-auto py-5 px-4 clip-mobile lg:clip-desktop relative h-[420px] w-2/5 min-w-[300px] lg:my-0 lg:mx-auto lg:py-16 lg:px-10 lg:max-w-[350px] text-center`}>
            ...
            <div className="test block w-2/5 min-w-[300px] mx-auto">
                <ul className='mt-8'>
                    <p className='text-[color:var(--ls-white)] font-bold text-2xl my-2 mx-0'><FontAwesomeIcon icon={faAngleRight} />  bullet point header</p>
